...
public class ArrayReferenceGuide {
    ...
    private static void declaration() {
        int[] anArray;
        int anotherArray[];
        System.out.println("Declaration Part");
    }
    ...
    private static void access() {
        ...
        System.out.println("Accessing part");
...
//        List<Integer> anotherList = Arrays.asList(anotherArray);
    ...
    private static void comparison() {
    	int [] num1 = new int [] {5,2,1,4,8};
    	int [] num2 = new int [] {5,2,1,4,8};
		String msg = num1 == num2 ? "Equal" : "Not Equal";
		System.out.println("Comparison of Two Arrays:" +msg);
    }
